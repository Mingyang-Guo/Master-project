...
from step2_paths import CACHE_DIR, OUTPUTS_DIR, READY_SUM2_CSV, BART_FINAL_DIR, resolve_from_project
...
# =========================================================
MODEL_PATH = BART_FINAL_DIR
TOKENIZER_PATH = MODEL_PATH
INPUT_CSV = READY_SUM2_CSV
OUT_ROOT = OUTPUTS_DIR / "BART"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run BART on the canonical Step 2 manifest.")
